...
client.on('message', message => {
  if (message.content === '-tt') {
    ...
    emb1.setFooter(message.author.tag, message.author.avatarURL);
    emb1.setTimestamp()
    ...
    emb2.setFooter(`Info requested by ${message.author.tag}`, message.author.displayAvatarURL)
    emb2.setTimestamp()
    ...
    emb3.setFooter(client.user.id, client.user.displayAvatarURL);
    emb3.setTimestamp()
